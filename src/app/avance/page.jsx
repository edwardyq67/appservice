  ...
  return (
    <section id='Clientes' className="py-20 bg-white">
      <div className="container mx-auto px-4">
        ...
        {/* Grid de sectores - Cambiado a whileInView */}
        <motion.div
        ...
        >
          {sectores.map((sector, index) => (
            <motion.div
              ...
              whileHover={{ y: -8 }}
              className="group relative cursor-pointer bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100"
            >
              {/* Icono con animación */}
              <div className="mb-6">
                <motion.div
        ...
        >
          <div className="inline-flex flex-col items-center">
            ...
            <motion.button
              ...
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="group inline-flex items-center gap-3 px-8 py-4 bg-default-500 hover:bg-default-600 text-white font-semibold rounded-lg transition-all duration-300 hover:gap-4 hover:shadow-lg hover:shadow-default-500/25 text-lg"
            >
